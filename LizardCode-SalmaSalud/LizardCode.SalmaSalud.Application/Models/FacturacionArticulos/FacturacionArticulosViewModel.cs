...
namespace LizardCode.SalmaSalud.Application.Models.FacturacionArticulos
{
    public class FacturacionArticulosViewModel
    {
        ...
        public FacturacionArticulosDetalle Detalle { get; set; }

        public List<FacturacionArticulosDetalle> Items { get; set; }
