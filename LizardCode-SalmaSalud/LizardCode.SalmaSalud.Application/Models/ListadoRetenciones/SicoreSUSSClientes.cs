...
{
    public class SicoreSUSSClientes : ISicoreCiti
    {
        ...
        [SubstringAttribute(iNro: 3, attrType: SubstringAttributeType.String, iLen: 14)]
        public string NroRetencion { get; set; }

        [SubstringAttribute(iNro: 4, attrType: SubstringAttributeType.Double, iLen: 11)]
