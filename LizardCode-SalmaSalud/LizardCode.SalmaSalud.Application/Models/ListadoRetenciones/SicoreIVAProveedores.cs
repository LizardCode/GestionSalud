...
{
    public class SicoreIVAProveedores : ISicoreCiti
    {
        ...
        [SubstringAttribute(iNro: 5, attrType: SubstringAttributeType.String, iLen: 3)]
        ...
        [SubstringAttribute(iNro: 9, attrType: SubstringAttributeType.DateTime, iLen: 10)]
        ...
        public string PorcentajeExclusison { get; set; }
        ...
        [SubstringAttribute(iNro: 18, attrType: SubstringAttributeType.String, iLen: 53)]
        public string EspaciosFinales { get; set; }
    }
}
