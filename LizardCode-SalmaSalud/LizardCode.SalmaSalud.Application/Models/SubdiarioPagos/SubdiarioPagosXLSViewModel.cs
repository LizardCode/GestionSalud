...
namespace LizardCode.SalmaSalud.Application.Models.SubdiarioPagos
{
    [Sheet("Subdiario Pagos")]
    public class SubdiarioPagosXLSViewModel
    {
        ...
        [HeaderCustom(3, "Proveedor", CellType.String)]
