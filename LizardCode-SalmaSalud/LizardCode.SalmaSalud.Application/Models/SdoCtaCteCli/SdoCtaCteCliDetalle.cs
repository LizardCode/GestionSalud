...
{
    public class SdoCtaCteCliDetalle
    {
        public SdoCtaCteCliDetalle()
        {
        ...
        [RepeaterColumn(Header = "Cliente", ControlType = RepeaterColumnType.Select2, Width = 0, Position = 3)]
        [RequiredEx]
        ...
        [RepeaterColumn(Header = "Total", ControlType = RepeaterColumnType.Currency, Width = 120, Position = 11, Readonly = true)]
        [AutoNumericConstraint(AutoNumericConstraintType.Currency, currencySymbol: "", decimalCharacter: ",", digitGroupSeparator: ".")]
        [RequiredEx]
