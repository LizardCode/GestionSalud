...
{
    public class DepositosBancoDetalle
    {
        [MasterDetailColumn(Header = "", Position = 1, Hidden = true)]
        public int IdDepositosBanco { get; set; }
        ...
        #region Modal de Tipo de Depósito

        [RequiredEx]
        [MasterDetailColumn(Header = "Tipo de Depósito", Hidden = true, Position = 4)]
        ...
        #region Cheque Terceros (Position 22/26)

        [RequiredEx]
        [MasterDetailColumn(Header = "Banco", Hidden = true, Position = 22)]
        ...
        [RequiredEx]
        [MaskConstraint(MaskConstraintType.Custom, blocks: "[10]", numericOnly: true)]
        [MasterDetailColumn(Header = "Número de Cheque", Hidden = true, Position = 24)]
        public string NumeroChequeTerceros { get; set; }

        [RequiredEx]
        [MasterDetailColumn(Header = "Fecha", Hidden = true, Position = 25)]
        [MasterDetailFormat(Format = MasterDetailColumnFormat.Date)]
        public DateTime? FechaChequeTerceros { get; set; }

        [RequiredEx]
        [MasterDetailColumn(Header = "Fecha Diferido", Hidden = true, Position = 26)]
        [MasterDetailFormat(Format = MasterDetailColumnFormat.Date)]
