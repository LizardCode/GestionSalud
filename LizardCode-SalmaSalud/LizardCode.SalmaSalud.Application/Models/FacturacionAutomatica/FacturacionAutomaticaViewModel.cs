...
{
    public class FacturacionAutomaticaViewModel
    {
        ...
        public FacturacionAutomaticaDetalle Detalle { get; set; }

        public List<FacturacionAutomaticaDetalle> Items { get; set; }
        ...
        public SelectList MaestroNumerosEstimados { get; set; }
