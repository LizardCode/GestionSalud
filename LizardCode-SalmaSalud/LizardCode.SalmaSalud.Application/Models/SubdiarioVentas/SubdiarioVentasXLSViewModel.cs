...
namespace LizardCode.SalmaSalud.Application.Models.SubdiarioVentas
{
    [Sheet("Subdiario Ventas")]
    public class SubdiarioVentasXLSViewModel
    {
        ...
        [HeaderCustom(7, "Total", CellType.Numeric)]
        public double Total { get; set; }

        [HeaderCustom(8, "Cod. Cuenta", CellType.String)]
        public string CodigoCuenta { get; set; }

        [HeaderCustom(9, "Cuenta", CellType.String)]
        public string NombreCuenta { get; set; }

        [HeaderCustom(10, "Importe", CellType.Numeric)]
