...
{
    public class OrdenesPagoDetalle
    {
        ...
        [RequiredEx]
        [MasterDetailColumn(Header = "Tipo de Pago", Hidden = true, Position = 4)]
        ...
        #region Transferencia (Position 19/21)
        ...
        [RequiredEx]
        [MaskConstraint(MaskConstraintType.Custom, blocks: "[10]", numericOnly: true)]
        [MasterDetailColumn(Header = "Número de Transferencia", Hidden = true, Position = 21)]
        public string NumeroTransferencia { get; set; }

        #endregion

        #region Cuenta Contable (Position 22/23)

        [RequiredEx]
        [MasterDetailColumn(Header = "Cuenta Contable", Hidden = true, Position = 22)]
        public int? IdCuentaContable { get; set; }
        public string CuentaContable { get; set; }

        #endregion

        #region Cheque Terceros (Position 23/27)

        [RequiredEx]
        [MasterDetailColumn(Header = "Banco", Hidden = true, Position = 23)]
        public int? IdChequeTerceros { get; set; }

        [RequiredEx]
        [MasterDetailColumn(Header = "Banco", Hidden = true, Position = 24)]
        public string BancoChequeTerceros { get; set; }

        [RequiredEx]
        [MaskConstraint(MaskConstraintType.Custom, blocks: "[10]", numericOnly: true)]
        [MasterDetailColumn(Header = "Número de Cheque", Hidden = true, Position = 25)]
        public string NumeroChequeTerceros { get; set; }

        [RequiredEx]
        [MasterDetailColumn(Header = "Fecha", Hidden = true, Position = 26)]
        [MasterDetailFormat(Format = MasterDetailColumnFormat.Date)]
        public DateTime? FechaChequeTerceros { get; set; }

        [RequiredEx]
        [MasterDetailColumn(Header = "Fecha Diferido", Hidden = true, Position = 27)]
        [MasterDetailFormat(Format = MasterDetailColumnFormat.Date)]
