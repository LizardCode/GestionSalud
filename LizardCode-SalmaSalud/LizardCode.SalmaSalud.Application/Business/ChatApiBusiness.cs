...
namespace LizardCode.SalmaSalud.Application.Business
{
    public class ChatApiBusiness : BaseBusiness, IChatApiBusiness
    {
        ...
        public async Task SendMessageSolicitudTurnoAsignado(string telefono, DateTime fechaTurno, string paciente, string especialidad, int? idPaciente = null, IDbTransaction transaction = null)
        {
            var message = string.Format("Estimado *{0}*. Hemos agendado un turno para la especialidad *{1}* para el *{2}* a las *{3}*. ",
                                paciente,
                                especialidad,
                                fechaTurno.ToString("dd/MM/yyyy"),
                                fechaTurno.ToString("HH:mm"));
