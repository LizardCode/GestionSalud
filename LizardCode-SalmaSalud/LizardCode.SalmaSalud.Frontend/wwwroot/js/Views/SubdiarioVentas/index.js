...
var SubdiarioVentasView = new (function () {
    ...
    this.init = function () {
        ...
        dtView = ReportLayout.initializeDatatable('idComprobanteVenta', columns, order, 30, false, columnDefs);
        ...
        $('.btGetExcel').click(function () {
            ...
            Utils.descargarDocumento('Generando reporte...', RootPath + 'SubdiarioVentas/GenerarExcel',
                null, RootPath + 'SubdiarioVentas/DescargarExcel', params);
        });
    ...
    function retrieveTotalesImputaciones() {
        ...
        Ajax.Execute('/SubdiarioVentas/DetalleImputaciones/', params)
    ...
    function retrieveDetalle() {
        ...
        if (row.child.isShown()) {
            ...
            var params = {
                idComprobante: row.data().idComprobanteVenta,
                fechaDesde: $('#Filter_FechaDesde').val(),
                fechaHasta: $('#Filter_FechaHasta').val()
            };

            Ajax.Execute('/SubdiarioVentas/GetDetalle', params)
                .done(function (response) {
