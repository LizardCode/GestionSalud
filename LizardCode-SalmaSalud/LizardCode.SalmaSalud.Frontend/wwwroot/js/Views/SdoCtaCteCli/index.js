...
var ABMSdoCtaCteCliView = new (function () {
    ...
    function buildControls() {
        ...
        var columns = [            
            { data: 'idSaldoCtaCteCli', visible: false },
        ...
        dtView = MaestroLayout.initializeDatatable('idSaldoCtaCteCli', columns, order);
    ...
    function bindControlEvents() {
        ...
        //btProcesarExcel.on('click', procesarExcel);
    ...
    function editDialogOpening($form, entity) {
        ...
        $form.find('#IdSaldoCtaCteCli_Edit').val(entity.idSaldoCtaCteCli);
