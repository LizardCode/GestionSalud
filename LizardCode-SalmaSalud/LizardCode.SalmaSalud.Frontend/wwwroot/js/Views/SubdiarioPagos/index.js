...
var SubdiarioPagosView = new (function () {
    ...
    this.init = function () {
        ...
        var columns = [
            { data: 'idOrdenPago', visible: false },
            ...
            { data: null, orderable: false, searchable: false, render: renderViewDetails }
        ];
        ...
        dtView = ReportLayout.initializeDatatable('idComprobanteCompra', columns, order, 30, false, columnDefs);
        ...
        $('.btGetExcel').click(function () {
            ...
            Utils.descargarDocumento('Generando reporte...', RootPath + 'SubdiarioCompras/GenerarExcel',
                null, RootPath + 'SubdiarioCompras/DescargarExcel', params);
        });
    ...
    function retrieveTotalesImputaciones() {
        ...
        Ajax.Execute('/SubdiarioPagos/DetalleImputaciones/', params)
    ...
    function retrieveDetalle() {
        ...
        if (row.child.isShown()) {
            ...
            var params = {
                idOrdenPago: row.data().idOrdenPago,
                fechaDesde: $('#Filter_FechaDesde').val(),
                fechaHasta: $('#Filter_FechaHasta').val()
            };

            Ajax.Execute('/SubdiarioPagos/GetDetalle', params)
                .done(function (response) {
