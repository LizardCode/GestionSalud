var OdontogramaView = new (function () {
    ...
    this.init = function () {
        OdontogramaView.piezas = [];

        if (JSON_COSO)
            OdontogramaView.piezas = JSON_COSO;
    ...
    function bindEvents() {
        $('.dvMainOdontograma .pieza').click(function () {
            var id = $('.ODONTOGRAMA_hdnIdEvolucion').val();
            ...
            Modals.loadAnyModal('detalleOdontogramaDialog', 'modal-70', action,
                function () {
                    var pieza = OdontogramaView.piezas.filter(o => o.pieza == nroPieza);
...
$(function () {
    ...
    OdontogramaView.init();
});

//# sourceURL=odontograma.js