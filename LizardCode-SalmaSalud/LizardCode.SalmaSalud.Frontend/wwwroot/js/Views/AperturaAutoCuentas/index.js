...
var ABMAperturaAutoCuentasView = new (function () {
    ...
    function buildControls() {
        ...
        dtView = MaestroLayout.initializeDatatable('idAsientoAperturaCierre', columns, order, pageLength);
    ...
    function editDialogOpening($form, entity) {
        ...
        $form.find('#IdAsientoAperturaCierre_Edit').val(entity.idAsientoAperturaCierre);
        $form.find('#Fecha_Edit').val(moment().format(enums.FormatoFecha.DefaultFormat));
    ...
    function retrieveRowDetails() {
        ...
        if (row.child.isShown()) {
            ...
            Ajax.Execute('/AperturaAutoCuentas/Obtener/' + row.data().idAsientoAperturaCierre, null, null, 'GET')
...
$(function () {
    ABMAperturaAutoCuentasView.init();
});
