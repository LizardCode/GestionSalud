...
var ABMFacturacionManualView = new (function () {
    ...
    function bindControlEvents() {
        ...
        $('select[name^=IdCliente]', modalNew).on('change', function (e) {
            ...
            Ajax.Execute('/FacturacionManual/GetComprobantesByCliente/', params)
                .done(function (response) {
        ...
        $('select[name^=IdCondicion]', modalNew).on('change', function (e) {
            ...
            if ($(this).val() && $('input[name^=Fecha]', modalNew).val()) {
                ...
                Ajax.Execute('/FacturacionManual/GetVencimiento/', params)
                    .done(function (response) {
    ...
    function retrieveRowDetails() {
        ...
        if (row.child.isShown()) {
            ...
            Ajax.Execute('/FacturacionManual/Obtener/' + row.data().idComprobanteVenta, null, null, 'GET')
                .done(function (response) {
    ...
    function retrieveAsientoDetails() {
        ...
        if (row.child.isShown()) {
            ...
            Ajax.Execute('/FacturacionManual/ObtenerAsiento/' + row.data().idComprobanteVenta, null, null, 'GET')
                .done(function (response) {
                    Ajax.ParseResponse(response,
                        function (data) {
    ...
    function retrieveValidarComprobante() {
        ...
        Ajax.Execute('/FacturacionManual/ValidarComprobantesById/', params)
            .done(function (response) {
                Ajax.ParseResponse(response,
                    function (data) {
                        if (data.error)
    ...
    function retrieveCAEComprobante() {
        ...
        Ajax.Execute('/FacturacionManual/ObtenerCAEComprobantesById/', params)
            .done(function (response) {
                Ajax.ParseResponse(response,
                    function (data) {
                        if (data.error)
