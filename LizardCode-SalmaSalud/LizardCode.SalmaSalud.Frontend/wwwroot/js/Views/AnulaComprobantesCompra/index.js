...
var ABMAnulaComprobantesCompraView = new (function () {
    ...
    function buildControls() {
        ...
        var columns = [
            ...
            { data: 'fecha', render: DataTableEx.renders.date, width: '5%' },
            { data: 'proveedor', render: DataTableEx.renders.ellipsis, width: '40%' },
            { data: 'moneda', width: '5%' },
    ...
    function bindControlEvents() {
        ...
        $('input[name^=NumeroComprobante]', modalNew).alphanum({
            allowNumeric: true,
            allow: "-",
            allowSpace: false,
            allowUpper: false,
        ...
        $('.btnCargaItems', modalNew).on('click', function (e) {
            ...
            var sucursalAnular = $('select[name^=SucursalAnular]', dialog).val();
            ...
            Ajax.Execute('/AnulaComprobantesCompra/GetItemsFactura/', params)
        ...
        $('select[name^=IdCondicion]', modalNew).on('change', function (e) {
            ...
            if ($(this).val() && $('input[name^=Fecha]', modalNew).val()) {
                ...
                Ajax.Execute('/AnulaComprobantesCompra/GetVencimiento/', params)
                    .done(function (response) {
    ...
    function retrieveRowDetails() {
        ...
        if (row.child.isShown()) {
            ...
            Ajax.Execute('/AnulaComprobantesCompra/Obtener/' + row.data().idComprobanteCompra, null, null, 'GET')
                .done(function (response) {
    ...
    function retrieveAsientoDetails() {
        ...
        if (row.child.isShown()) {
            ...
            Ajax.Execute('/AnulaComprobantesCompra/ObtenerAsiento/' + row.data().idComprobanteCompra, null, null, 'GET')
                .done(function (response) {
                    Ajax.ParseResponse(response,
                        function (data) {
    ...
    function retrieveValidarComprobante() {
        ...
        Ajax.Execute('/AnulaComprobantesCompra/ValidarComprobantesById/', params)
            .done(function (response) {
                Ajax.ParseResponse(response,
                    function (data) {
                        if (data.error)
...
$(function () {
    ABMAnulaComprobantesCompraView.init();
});
