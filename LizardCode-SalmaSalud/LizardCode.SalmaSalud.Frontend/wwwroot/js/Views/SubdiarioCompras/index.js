...
var SubdiarioComprasView = new (function () {
    ...
    function retrieveTotalesImputaciones() {
        ...
        Ajax.Execute('/SubdiarioCompras/DetalleImputaciones/', params)
    ...
    function retrieveDetalle() {
        ...
        if (row.child.isShown()) {
            ...
            var params = {
                idComprobante: row.data().idComprobanteCompra,
                fechaDesde: $('#Filter_FechaDesde').val(),
                fechaHasta: $('#Filter_FechaHasta').val()
            };

            Ajax.Execute('/SubdiarioCompras/GetDetalle', params)
                .done(function (response) {
