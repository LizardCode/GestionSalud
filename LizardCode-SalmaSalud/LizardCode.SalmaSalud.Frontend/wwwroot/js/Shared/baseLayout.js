var BaseLayoutView = new (function () {
    ...
    var categoryScroll = {
        scrollCat: function () {
            ...
            var sidebarWrapperTop = 0;

            if (sidebarWrapper !== undefined)
                sidebarWrapper = sidebarWrapper.offsetTop - 20;
    ...
    var toggleFunction = {
        sidebar: function ($recentSubmenu) {
            $('.sidebarCollapse').on('click', function (sidebar) {
                ...
                $('.sidebarCollapse i').toggleClass('fa-chevron-left');
                $('.sidebarCollapse i').toggleClass('fa-chevron-right');
            });
        },
    ...
    this.expiredSession = function () {

        var element = $('div.expired-session');
        var counter = element.find('span.counter');
    ...
    function bindEvents() {
        ...
        desktopResolution.onRefresh();
        desktopResolution.onResize();

        mobileResolution.onRefresh();
        mobileResolution.onResize();
