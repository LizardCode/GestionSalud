    ...
    $.fn.DataTableEx = function (settings) {
        ...
        var defaultSettings = {
            ...
            initComplete: function () {
                if ($.isFunction(defaultSettings.onExport)) {
                    $("div.buttons div.dataTables_filter").prepend('<a class="export" title="Exportar a Excel"><i class="fa fa-file-excel-o fa-lg" aria-hidden="true"></i></a>');
                    $("div.buttons div.dataTables_filter .export").click(defaultSettings.onExport);
                }
            }
        };
