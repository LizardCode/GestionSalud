...
var MaestroLayout = new (function () {
    ...
    this.buildControls = function () {
        ...
        $('.modal select:not(.no-select2)', mainClass).select2();
    ...
    this.initializeDatatable = function (keyProperty, columns, order, pageLength, multipleSelection) {
    ...
    this.ajaxFormBegin = function (context, arguments) {
        ...
        buttonLoader(btSave, true, 'Guardando');
    ...
    function buttonLoader(button, flag, text) {
