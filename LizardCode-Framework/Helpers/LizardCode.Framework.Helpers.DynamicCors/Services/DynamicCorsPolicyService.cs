...
namespace LizardCode.Framework.Helpers.DynamicCors.Services
{
    public class DynamicCorsPolicyService : IDynamicCorsPolicyService
    {
        ...
        public DynamicCorsPolicyService(
        ...
        public async Task<CorsResult> EvaluatePolicy(HttpContext context, CorsPolicy policy)
        {
            ...
            var corsResult = new CorsResult
            {
                ...
                IsOriginAllowed = await IsOriginAllowed(context, policy, origin),
            };
        ...
        private async Task<bool> IsOriginAllowed(HttpContext context, CorsPolicy policy, StringValues origin)
        {
            ...
            return policy.AllowAnyOrigin
                   ...
                   || await _dynamicCorsPolicyResolver.ResolveForOrigin(context, origin);
        }
    }
}