using LizardCode.Framework.Helpers.BarcodeLib.Symbologies;
using System;
    ...
    public class Barcode : IDisposable
    {
        ...
        private Image Label_ITF14(Image img)
        {
            try
            {
                ...
                using (Graphics g = Graphics.FromImage(img))
                {
                    ...
                    g.DrawString(AlternateLabel == null ? RawData : AlternateLabel, font, new SolidBrush(ForeColor), img.Width / 2, img.Height - font.Height + 1, f);
        ...
        private Image Label_Generic(Image img)
        {
            try
            {
                ...
                using (Graphics g = Graphics.FromImage(img))
                {
                    ...
                    g.FillRectangle(new SolidBrush(BackColor), new RectangleF(0, LabelY, img.Width, font.Height));

                    //draw datastring under the barcode image
                    g.DrawString(AlternateLabel == null ? RawData : AlternateLabel, font, new SolidBrush(ForeColor), new RectangleF(0, LabelY, img.Width, font.Height), f);
        ...
        private Image Label_UPCA(Image img)
        {
            try
            {
                ...
                System.Drawing.Font font = new System.Drawing.Font("OCR A Extended", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0); ;
