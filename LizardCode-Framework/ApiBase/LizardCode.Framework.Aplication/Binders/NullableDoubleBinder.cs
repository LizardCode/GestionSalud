...
{
    public class NullableDoubleBinderProvider : IModelBinderProvider
    {
        ...
        public class NullableDoubleBinder : IModelBinder
        {
            public Task BindModelAsync(ModelBindingContext bindingContext)
            {
                ...
                {
                    var actualValue =
                        string.IsNullOrWhiteSpace(values.FirstValue) || values.FirstValue == "null"
                            ? default
